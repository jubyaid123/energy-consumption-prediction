...
scaled_data_meter1 = scaler.fit_transform(data['Meter1'].values.reshape(-1, 1))
scaled_data_meter2 = scaler.fit_transform(data['Meter2'].values.reshape(-1, 1))
...
X_1, Y_1 = create_dataset(scaled_data_meter1)
X_2, Y_2 = create_dataset(scaled_data_meter2)
